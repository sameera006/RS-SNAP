...
```
**Reading data for Sentinel Shapefile

```{r}
bare_earth <- st_read("Data/shapefile-sentinel/bare_earth_Polygon.shp")
grass <- st_read("Data/shapefile-sentinel/Grass_Polygon.shp")
forest <- st_read("Data/shapefile-sentinel/Forest_Polygon.shp")
urban <- st_read("Data/shapefile-sentinel/urban_Polygon.shp")
high_urban <- st_read("Data/shapefile-sentinel/high_urban_Polygon.shp")
```
